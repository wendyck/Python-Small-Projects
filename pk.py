...
def lookupByUsername(userID):
    urltemplateByUsername = "https://www.googleapis.com/youtube/v3/channels?key=AIzaSyAeKRU0Wq7f71tcNaPZO0LcEoCyx6OqrcI&part=statistics&forUsername="
    myreq = urltemplateByUsername + userID;
    print myreq;
    doLookup(myreq);

def lookupByChannelID(channel):
    urltemplateByChannelID = "https://www.googleapis.com/youtube/v3/channels?key=AIzaSyAeKRU0Wq7f71tcNaPZO0LcEoCyx6OqrcI&part=statistics&part=statistics&id="
